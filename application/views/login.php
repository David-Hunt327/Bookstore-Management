          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info align-items-center">
                <div class="content ">
                <h1 class="text-center">Caritas BookStore System</h1>
                  <div class="logo text-center">
                    <img src="<?php echo base_url(); ?>assets/img/bookstoref.png" alt="User Icon" width="250px"> 
                  </div>
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <?php
                        $notifikasi = $this->session->flashdata('message');
                        if($notifikasi != NULL)
                        {
                          echo '
                  ...
                  <form method="post" class="form-validate" action="<?php echo base_url('index.php/admin/proses_login') ?>">
                    ...
                    <div class="form-group">
                      ...
                      <a href="<?php echo base_url('index.php/admin/register') ?>" class="btn btn-primary float-right">Register</a>
