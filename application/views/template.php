                ...
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <div class="navbar-header">
                        <!-- Navbar Brand --><a href="#" class="navbar-brand">
                            <div class="brand-text brand-big"><span>Caritas BookStore System</span></div>
                            <div class="brand-text brand-small">Caritas BookStore System</div></a>
    ...
    <div class="page-content d-flex">
        ...
        <nav class="side-navbar">
            ...
            <div class="sidebar-header d-flex align-items-center">
                ...
                <div class="title">
                    <h1 class="h4"><?= $this->session->userdata('user_name') ?></h1> <!-- Ensure this is set correctly -->
                    <p><?= $this->session->userdata('level') ?></p>
                </div>
            </div>
            <!-- Sidebar Navigation Menus--><span class="heading">Navigation</span>
                ...
                <?php if ($this->session->userdata('level') == 'admin') {
                    ...
                    <li>
                        <a href="'.base_url('index.php/categories').'">
                            <i class="fa fa-bookmark"></i> <span>Books Category</span>
                        </a>
                    </li>
                    <li>
                        <a href="'.base_url('index.php/book-details').'">
                            <i class="fa fa-book"></i> <span>Books Section </span>
                        </a>
                    </li>
                    <li>
                        <a href="'.base_url('index.php/sales').'">
                            <i class="fa fa-dollar"></i> <span>Manage Sales</span>
                        </a>
                    </li>
                    <li>
                        <a href="'.base_url('index.php/transaction-history').'">
                            <i class="fa fa-history"></i> <span>Transaction History</span>
                        </a>
                    </li>
                    <li>
                        <a href="'.base_url('index.php/users').'"> <!-- Corrected URL -->
        ...
        <div class="content-inner">
            <?php $this->load->view($content); ?> <!-- Use $content instead of $konten -->
        </div>
    </div>
</div>
<!-- JavaScript files-->
