        ...
        <div class="container-fluid">
            ...
            <table class="table table-hover table-bordered" id="example" ui-options=ui-options="{ &quot;paging&quot;: { &quot;enabled&quot;: true }, &quot;filtering&quot;: { &quot;enabled&quot;: true }, &quot;sorting&quot;: { &quot;enabled&quot;: true }}">
                ...
                <tbody style="background-color: white;">
                    <?php $no = 0; foreach ($display_users as $user) : $no++; ?>
                    <tr>
                        <td><?=$no?></td>
                        ...
                        <td>
                            ...
                            <a href="<?=base_url('index.php/users/delete/'.$user->user_code)?>" onclick="return confirm('Are you sure to delete this user?')" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
...
<script type="text/javascript">
    ...
    function edit(a) {
        $.ajax({
            type: "post",
            url: "<?=base_url()?>index.php/users/edit/" + a,
            dataType: "json",
